...
1539
\end{verbatim}
\caption{De tre tresiffriga talen är alla primtal och siffrorna $1, 2, \dots, 9$ används precis en gång i de tre talen}
\end{figure}
...
av de nio siffrorna $1, 2, \dots, 9$ precis en gång i de tre talen.
